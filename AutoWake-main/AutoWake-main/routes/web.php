...
Route::get('Rota_iniciada', [RotasController::class, 'exibe_rotas'])->name('exibe_rotas');

Route::get('Clima', [ClimaController::class, 'exibe_clima'])->name('exibe_clima');

Route::resource('relatorios', RelatorioController::class);

Route::get('/chatbot', [ChatBotController::class, 'exibe_chatbot'])->name('exibe_chatbot');

Route::get('/internal-chat', [InternalChatController::class, 'index'])
    ->name('internal_chat.index');

Route::get('/internal-chat/messages', [InternalChatController::class, 'getMessages'])
    ->name('internal_chat.get');

Route::post('/internal-chat/send', [InternalChatController::class, 'sendMessage'])
    ->name('internal_chat.send');
